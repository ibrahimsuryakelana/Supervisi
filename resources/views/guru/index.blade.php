...
<body>
      ...
      <TABLE class="table table-hover">
        ...
        <tr>
            <td>{{ $guru->id}}</td>
            <td>{{ $guru->judul_rpp}}</td>
            <td>{{ $guru->rpp}}</td>
            <td>{{ $guru->materi}}</td>
            <td>{{ $guru->id_guru}}</td>
            <td>{{ $guru->nama_guru}}</td>
            <td>{{ $guru->nama_supervisor}}</td>
            <td>{{ $guru->tanggal_upload}}</td>
            <td>{{ $guru->status}}</td>
        </tr>
        @endforeach
      </table>
        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
           <form action="/guru/create" method="POST">
            ...
            <div class="form-group">
              <label for="exampleInputEmail1">File guru</label>
              <input name="materi" type="file" class="form-control" id="exampleInputEmail1" aria-describedby="materi" placeholder="File guru" >
            </div>
